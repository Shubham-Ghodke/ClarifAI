...
class RAGService:
    def __init__(self):
        print("[LAZY INIT] Initializing RAGService...")
        ...
        try:
            if api_key and USE_GEMINI:
                ...
                raise ValueError("GOOGLE_API_KEY environment variable is not set or Gemini is disabled.")
        except Exception as e:
            print(f"[ERROR] Failed to initialize Google Gemini embeddings: {e}")
            raise e
        ...
        print("[LAZY INIT] RAGService initialized successfully.")
